...
public class QnAController {
    ...
    public CustomResponse<List<CommonTrainingQnAListResponseDTO>> getTrainingQnAs(@PathVariable Long trainingId) {
    ...
    /*@PostMapping("/trainer/qna")
    public CustomResponse<Void> createTrainingAnswer(@AuthenticationPrincipal(expression = "user") User user) {
